...
@Entity(tableName = "daily_data",
        foreignKeys = [ForeignKey(entity = DailyCache::class, parentColumns = ["id"], childColumns = ["dailyId"], onDelete = CASCADE, onUpdate = CASCADE)])
data class DailyDataCache(var time: Long = 0,
                          var summary: String = "",
                          var placeId: String = "",
                          var icon: String = "",
